"""
Django settings for imtepr project.
...
SECRET_KEY = 'nxvayr1dfm-b@qo6(wm@y(zaon7j_g5@+yv$b0h^85l03gsr+u'
...
WSGI_APPLICATION = 'imtepr.wsgi.application'
...
BROKER_URL = 'redis://redis:6379/0'  # Broker 使用 Redis, 使用0数据库(暂时不是很清楚原理)
